        ...
        <div className="hidden md:grid md:grid-cols-3 w-full gap-2 items-center">
          ...
          <div className="flex justify-end">
            <a
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#c94340] text-white text-sm font-bold rounded-lg border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all"
            >
