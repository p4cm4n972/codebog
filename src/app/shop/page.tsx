...
function ShopContent() {
    ...
    // Show skeleton while loading auth, redirect silently if not logged in
    if (isLoading || (user && loadingBalance)) {
        return (
            <main className="min-h-screen bg-[#0a0f0a] font-mono text-white p-4 md:p-8">
                <div className="max-w-4xl mx-auto animate-pulse">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="h-10 w-64 bg-purple-900/50 rounded mb-2" />
                        <div className="h-4 w-80 bg-gray-700 rounded" />
                    </div>

                    {/* Balance card skeleton */}
                    <div className="mb-8 p-6 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-4 border-purple-500/50 rounded-lg">
                        <div className="flex items-center justify-between">
                            <div>
                                <div className="h-3 w-24 bg-gray-700 rounded mb-3" />
                                <div className="flex items-center gap-3">
                                    <div className="w-12 h-12 bg-purple-700/50 rounded" />
                                    <div className="h-10 w-24 bg-purple-700/50 rounded" />
                                </div>
                            </div>
                    ...
                    <div className="h-8 w-48 bg-yellow-900/50 rounded mb-6" />

                    {/* Gem packs skeleton */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="p-6 border-4 border-purple-500/30 bg-purple-900/10 rounded-lg">
                                <div className="text-center mb-4">
                                    <div className="w-16 h-16 bg-purple-700/30 rounded-full mx-auto mb-2" />
                                    <div className="h-8 w-20 bg-gray-700 rounded mx-auto mb-1" />
                                    <div className="h-3 w-16 bg-gray-700 rounded mx-auto" />
                                </div>
                                <div className="text-center mb-4">
                                    <div className="h-8 w-16 bg-gray-700 rounded mx-auto" />
                                </div>
                                <div className="h-12 w-full bg-purple-700/30 rounded" />
                            </div>
                        ))}
                    </div>

                    {/* How it works skeleton */}
                    <div className="p-6 bg-black border-4 border-gray-700/50 rounded-lg">
